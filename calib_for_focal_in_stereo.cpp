...
#include <cmath>
#define N 1
#define FOC_IN_PIX 928.334  // Make sure to adapt your own camera focal!
...
int main() {
    ...
    double wldDist = 0;     // metric displacement, return in mm (millimeters)
    ...
    l_src_fir = imread("");     // left image of the first pos
    l_src_sec = imread("");     // right image of the first pos
    r_src_fir = imread("");     // left image of the second pos
    r_src_sec = imread("");     // right image of the second pos
